...
using CloudPlatformDemo.LocalCerts;
...
{
    /// <summary>
    /// This is essentially a psuedo-SNI logic to use container certificate when request is coming from another container on the platform
    /// This is meant to allow mTLS based auth between two apps on the platform when using c2c networking
    /// </summary>
