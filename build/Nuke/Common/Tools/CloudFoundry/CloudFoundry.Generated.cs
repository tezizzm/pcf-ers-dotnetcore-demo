...
namespace Nuke.Common.Tools.CloudFoundry
{
    ...
    public static partial class CloudFoundryTasks
    {
        ...
        ///     <li><c>--app-start-timeout</c> via <see cref="CloudFoundryPushSettings.AppStartTimeout"/></li>
        ///     <li><c>--buildpack</c> via <see cref="CloudFoundryPushSettings.Buildpack"/></li>
        ///     <li><c>--disk</c> via <see cref="CloudFoundryPushSettings.Disk"/></li>
        ///     <li><c>--docker-image</c> via <see cref="CloudFoundryPushSettings.DockerImage"/></li>
        ...
        ///     <li><c>--endpoint</c> via <see cref="CloudFoundryPushSettings.Endpoint"/></li>
        ///     <li><c>--instances</c> via <see cref="CloudFoundryPushSettings.Instances"/></li>
        ///     <li><c>--memory</c> via <see cref="CloudFoundryPushSettings.Memory"/></li>
        ///     <li><c>--no-manifest</c> via <see cref="CloudFoundryPushSettings.NoManifest"/></li>
        ...
        ///     <li><c>--no-wait</c> via <see cref="CloudFoundryPushSettings.NoWait"/></li>
        ///     <li><c>--random-route</c> via <see cref="CloudFoundryPushSettings.RandomRoute"/></li>
        ///     <li><c>--stack</c> via <see cref="CloudFoundryPushSettings.Stack"/></li>
        ///     <li><c>--stack</c> via <see cref="CloudFoundryPushSettings.Strategy"/></li>
        ///     <li><c>--start-command</c> via <see cref="CloudFoundryPushSettings.StartCommand"/></li>
        ...
        /// <summary>
        ///   <p>Create an Application in the target space</p>
        ///   <p>For more details, visit the <a href="https://docs.cloudfoundry.org/cf-cli/cf-help.html">official website</a>.</p>
        /// </summary>
        /// <remarks>
        ///   <p>This is a <a href="http://www.nuke.build/docs/authoring-builds/cli-tools.html#fluent-apis">CLI wrapper with fluent API</a> that allows to modify the following arguments:</p>
        ///   <ul>
        ///     <li><c>&lt;name&gt;</c> via <see cref="CloudFoundryCreateAppSettings.Name"/></li>
        ///     <li><c>--app-type</c> via <see cref="CloudFoundryCreateAppSettings.AppType"/></li>
        ///   </ul>
        /// </remarks>
        public static IReadOnlyCollection<Output> CloudFoundryCreateApp(CloudFoundryCreateAppSettings toolSettings = null)
        {
            toolSettings = toolSettings ?? new CloudFoundryCreateAppSettings();
            using var process = ProcessTasks.StartProcess(toolSettings);
            process.AssertZeroExitCode();
            return process.Output;
        }
        ...
        ///   </ul>
        /// </remarks>
        public static IReadOnlyCollection<Output> CloudFoundryCreateApp(Configure<CloudFoundryCreateAppSettings> configurator)
        {
            return CloudFoundryCreateApp(configurator(new CloudFoundryCreateAppSettings()));
        }
        /// <summary>
        ///   <p>Create an Application in the target space</p>
        ///   <p>For more details, visit the <a href="https://docs.cloudfoundry.org/cf-cli/cf-help.html">official website</a>.</p>
        ...
        ///   </ul>
        /// </remarks>
        public static IEnumerable<(CloudFoundryCreateAppSettings Settings, IReadOnlyCollection<Output> Output)> CloudFoundryCreateApp(CombinatorialConfigure<CloudFoundryCreateAppSettings> configurator, int degreeOfParallelism = 1, bool completeOnFailure = false)
        {
            return configurator.Invoke(CloudFoundryCreateApp, CloudFoundryLogger, degreeOfParallelism, completeOnFailure);
        }
        /// <summary>
        ...
        ///   <p>This is a <a href="http://www.nuke.build/docs/authoring-builds/cli-tools.html#fluent-apis">CLI wrapper with fluent API</a> that allows to modify the following arguments:</p>
        ///   <ul>
        ///     <li><c>&lt;buildpackName&gt;</c> via <see cref="CloudFoundryCreateBuildpackSettings.BuildpackName"/></li>
        ///     <li><c>&lt;path&gt;</c> via <see cref="CloudFoundryCreateBuildpackSettings.Path"/></li>
        ///     <li><c>&lt;position&gt;</c> via <see cref="CloudFoundryCreateBuildpackSettings.Position"/></li>
        ///     <li><c>--disable</c> via <see cref="CloudFoundryCreateBuildpackSettings.Disable"/></li>
        ///   </ul>
        /// </remarks>
        public static IReadOnlyCollection<Output> CloudFoundryCreateBuildpack(CloudFoundryCreateBuildpackSettings toolSettings = null)
        {
            toolSettings = toolSettings ?? new CloudFoundryCreateBuildpackSettings();
            using var process = ProcessTasks.StartProcess(toolSettings);
            process.AssertZeroExitCode();
            return process.Output;
        }
        ...
        ///   </ul>
        /// </remarks>
        public static IReadOnlyCollection<Output> CloudFoundryCreateBuildpack(Configure<CloudFoundryCreateBuildpackSettings> configurator)
        {
            return CloudFoundryCreateBuildpack(configurator(new CloudFoundryCreateBuildpackSettings()));
        }
        /// <summary>
        ///   <p>Create a buildpack</p>
        ///   <p>For more details, visit the <a href="https://docs.cloudfoundry.org/cf-cli/cf-help.html">official website</a>.</p>
        ...
        ///   </ul>
        /// </remarks>
        public static IEnumerable<(CloudFoundryCreateBuildpackSettings Settings, IReadOnlyCollection<Output> Output)> CloudFoundryCreateBuildpack(CombinatorialConfigure<CloudFoundryCreateBuildpackSettings> configurator, int degreeOfParallelism = 1, bool completeOnFailure = false)
        {
            return configurator.Invoke(CloudFoundryCreateBuildpack, CloudFoundryLogger, degreeOfParallelism, completeOnFailure);
        }
        /// <summary>
        ...
        ///   <p>This is a <a href="http://www.nuke.build/docs/authoring-builds/cli-tools.html#fluent-apis">CLI wrapper with fluent API</a> that allows to modify the following arguments:</p>
        ///   <ul>
        ///     <li><c>&lt;buildpackName&gt;</c> via <see cref="CloudFoundryUpdateBuildpackSettings.BuildpackName"/></li>
        ///     <li><c>--assign-stack</c> via <see cref="CloudFoundryUpdateBuildpackSettings.AssignStack"/></li>
        ///     <li><c>--disable</c> via <see cref="CloudFoundryUpdateBuildpackSettings.Disable"/></li>
        ///     <li><c>--enable</c> via <see cref="CloudFoundryUpdateBuildpackSettings.Enable"/></li>
        ///     <li><c>--lock</c> via <see cref="CloudFoundryUpdateBuildpackSettings.Lock"/></li>
        ///     <li><c>--path</c> via <see cref="CloudFoundryUpdateBuildpackSettings.Path"/></li>
        ///     <li><c>--position</c> via <see cref="CloudFoundryUpdateBuildpackSettings.Position"/></li>
        ///     <li><c>--rename</c> via <see cref="CloudFoundryUpdateBuildpackSettings.Rename"/></li>
        ///     <li><c>--stack</c> via <see cref="CloudFoundryUpdateBuildpackSettings.Stack"/></li>
        ///     <li><c>--unlock</c> via <see cref="CloudFoundryUpdateBuildpackSettings.Unlock"/></li>
        ///   </ul>
        /// </remarks>
        public static IReadOnlyCollection<Output> CloudFoundryUpdateBuildpack(CloudFoundryUpdateBuildpackSettings toolSettings = null)
        {
            toolSettings = toolSettings ?? new CloudFoundryUpdateBuildpackSettings();
            using var process = ProcessTasks.StartProcess(toolSettings);
            process.AssertZeroExitCode();
            return process.Output;
        }
        ...
        ///   </ul>
        /// </remarks>
        public static IReadOnlyCollection<Output> CloudFoundryUpdateBuildpack(Configure<CloudFoundryUpdateBuildpackSettings> configurator)
        {
            return CloudFoundryUpdateBuildpack(configurator(new CloudFoundryUpdateBuildpackSettings()));
        }
        /// <summary>
        ///   <p>Update a buildpack</p>
        ///   <p>For more details, visit the <a href="https://docs.cloudfoundry.org/cf-cli/cf-help.html">official website</a>.</p>
        ...
        ///   </ul>
        /// </remarks>
        public static IEnumerable<(CloudFoundryUpdateBuildpackSettings Settings, IReadOnlyCollection<Output> Output)> CloudFoundryUpdateBuildpack(CombinatorialConfigure<CloudFoundryUpdateBuildpackSettings> configurator, int degreeOfParallelism = 1, bool completeOnFailure = false)
        {
            return configurator.Invoke(CloudFoundryUpdateBuildpack, CloudFoundryLogger, degreeOfParallelism, completeOnFailure);
        }
    }
    ...
    public partial class CloudFoundryPushSettings : ToolSettings
    {
        ...
        /// </summary>
        public virtual int? AppStartTimeout { get; internal set; }
        /// <summary>
        ...
        ///   Number of instances
        /// </summary>
        public virtual int? Instances { get; internal set; }
        /// <summary>
        ///   Path to manifest
        /// </summary>
        ...
        /// </summary>
        public virtual bool? NoManifest { get; internal set; }
        /// <summary>
        ...
        ///   Startup command
        /// </summary>
        public virtual string StartCommand { get; internal set; }
        /// <summary>
        ///   Stack to use (a stack is a pre-built file system, including an operating system, that can run apps)
        /// </summary>
        public virtual Strategy Strategy { get; internal set; }
        /// <summary>
        ...
        protected override Arguments ConfigureProcessArguments(Arguments arguments)
        {
            arguments
              ...
              .Add("--start-command {value}", StartCommand)
              .Add("--stack {value}", Strategy)
    ...
    #endregion
    #region CloudFoundryCreateAppSettings
    /// <summary>
    ///   Used within <see cref="CloudFoundryTasks"/>.
    /// </summary>
    [PublicAPI]
    [ExcludeFromCodeCoverage]
    [Serializable]
    public partial class CloudFoundryCreateAppSettings : ToolSettings
    {
        /// <summary>
        ///   Path to the CloudFoundry executable.
        /// </summary>
        ...
        /// </summary>
        public virtual AppType AppType { get; internal set; }
        protected override Arguments ConfigureProcessArguments(Arguments arguments)
        {
            arguments
              .Add("create-app")
              .Add("{value}", Name)
              .Add("--app-type {value}", AppType);
            return base.ConfigureProcessArguments(arguments);
        }
    }
    #endregion
    #region CloudFoundryCreateBuildpackSettings
    /// <summary>
    ///   Used within <see cref="CloudFoundryTasks"/>.
    /// </summary>
    [PublicAPI]
    [ExcludeFromCodeCoverage]
    [Serializable]
    public partial class CloudFoundryCreateBuildpackSettings : ToolSettings
    {
        /// <summary>
        ///   Path to the CloudFoundry executable.
        /// </summary>
        ...
        {
            arguments
              .Add("create-buildpack")
              .Add("{value}", BuildpackName)
              .Add("{value}", Path)
              .Add("{value}", Position)
              .Add("--disable", Disable);
            return base.ConfigureProcessArguments(arguments);
    ...
    #endregion
    #region CloudFoundryUpdateBuildpackSettings
    /// <summary>
    ///   Used within <see cref="CloudFoundryTasks"/>.
    /// </summary>
    [PublicAPI]
    [ExcludeFromCodeCoverage]
    [Serializable]
    public partial class CloudFoundryUpdateBuildpackSettings : ToolSettings
    {
        /// <summary>
        ///   Path to the CloudFoundry executable.
        /// </summary>
        ...
        /// </summary>
        public virtual string AssignStack { get; internal set; }
        /// <summary>
        ///   Disable the buildpack from being used for staging
        /// </summary>
        public virtual bool? Disable { get; internal set; }
        ...
        /// </summary>
        public virtual string Rename { get; internal set; }
        /// <summary>
        ...
        /// </summary>
        public virtual bool? Unlock { get; internal set; }
        protected override Arguments ConfigureProcessArguments(Arguments arguments)
        {
            arguments
              .Add("update-buildpack")
              .Add("{value}", BuildpackName)
              .Add("--assign-stack {value}", AssignStack)
              .Add("--disable", Disable)
              .Add("--enable", Enable)
              .Add("--lock", Lock)
              .Add("--path {value}", Path)
              .Add("--position {value}", Position)
              .Add("--rename {value}", Rename)
              .Add("--stack {value}", Stack)
              .Add("--unlock", Unlock);
            return base.ConfigureProcessArguments(arguments);
        }
    ...
    public static partial class CloudFoundryPushSettingsExtensions
    {
        ...
        #endregion
        #region AppStartTimeout
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryPushSettings.AppStartTimeout"/></em></p>
        ///   <p>Time (in seconds) allowed to elapse between starting up an app and the first healthy response from the app</p>
        /// </summary>
        [Pure]
        public static T SetAppStartTimeout<T>(this T toolSettings, int? appStartTimeout) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.AppStartTimeout = appStartTimeout;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryPushSettings.AppStartTimeout"/></em></p>
        ///   <p>Time (in seconds) allowed to elapse between starting up an app and the first healthy response from the app</p>
        /// </summary>
        [Pure]
        public static T ResetAppStartTimeout<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.AppStartTimeout = null;
            return toolSettings;
        }
        #endregion
        #region Buildpack
        ...
        ///   <p>Custom buildpack by name (e.g. my-buildpack) or Git URL (e.g. 'https://github.com/cloudfoundry/java-buildpack.git') or Git URL with a branch or tag (e.g. 'https://github.com/cloudfoundry/java-buildpack.git#v3.3.0' for 'v3.3.0' tag). To use built-in buildpacks only, specify 'default' or 'null'</p>
        /// </summary>
        [Pure]
        ...
        #region Disk
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryPushSettings.Disk"/></em></p>
        ///   <p>Disk limit (e.g. 256M, 1024M, 1G)</p>
        /// </summary>
        [Pure]
        public static T SetDisk<T>(this T toolSettings, string disk) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryPushSettings.Disk"/></em></p>
        ///   <p>Disk limit (e.g. 256M, 1024M, 1G)</p>
        /// </summary>
        [Pure]
        public static T ResetDisk<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        ///   <p>Repository username; used with password from environment variable CF_DOCKER_PASSWORD</p>
        /// </summary>
        [Pure]
        ...
        #region Endpoint
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryPushSettings.Endpoint"/></em></p>
        ///   <p>Valid path on the app for an HTTP health check. Only used when specifying --health-check-type=http</p>
        /// </summary>
        [Pure]
        public static T SetEndpoint<T>(this T toolSettings, string endpoint) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryPushSettings.Endpoint"/></em></p>
        ///   <p>Valid path on the app for an HTTP health check. Only used when specifying --health-check-type=http</p>
        /// </summary>
        [Pure]
        public static T ResetEndpoint<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        #region Instances
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryPushSettings.Instances"/></em></p>
        ///   <p>Number of instances</p>
        /// </summary>
        [Pure]
        public static T SetInstances<T>(this T toolSettings, int? instances) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryPushSettings.Instances"/></em></p>
        ///   <p>Number of instances</p>
        /// </summary>
        [Pure]
        public static T ResetInstances<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        #region Memory
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryPushSettings.Memory"/></em></p>
        ///   <p>Memory limit (e.g. 256M, 1024M, 1G)</p>
        /// </summary>
        [Pure]
        public static T SetMemory<T>(this T toolSettings, string memory) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryPushSettings.Memory"/></em></p>
        ///   <p>Memory limit (e.g. 256M, 1024M, 1G)</p>
        /// </summary>
        [Pure]
        public static T ResetMemory<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        #region NoManifest
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryPushSettings.NoManifest"/></em></p>
        ///   <p>Ignore manifest file</p>
        /// </summary>
        [Pure]
        public static T SetNoManifest<T>(this T toolSettings, bool? noManifest) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.NoManifest = noManifest;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryPushSettings.NoManifest"/></em></p>
        ///   <p>Ignore manifest file</p>
        /// </summary>
        [Pure]
        public static T ResetNoManifest<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.NoManifest = null;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Enables <see cref="CloudFoundryPushSettings.NoManifest"/></em></p>
        ///   <p>Ignore manifest file</p>
        /// </summary>
        [Pure]
        public static T EnableNoManifest<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.NoManifest = true;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Disables <see cref="CloudFoundryPushSettings.NoManifest"/></em></p>
        ///   <p>Ignore manifest file</p>
        /// </summary>
        [Pure]
        public static T DisableNoManifest<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.NoManifest = false;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Toggles <see cref="CloudFoundryPushSettings.NoManifest"/></em></p>
        ///   <p>Ignore manifest file</p>
        /// </summary>
        [Pure]
        public static T ToggleNoManifest<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.NoManifest = !toolSettings.NoManifest;
            return toolSettings;
        }
        #endregion
        #region NoRoute
        ...
        #region NoWait
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryPushSettings.NoWait"/></em></p>
        ///   <p>Exit when the first instance of the web process is healthy</p>
        /// </summary>
        [Pure]
        public static T SetNoWait<T>(this T toolSettings, bool? noWait) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryPushSettings.NoWait"/></em></p>
        ///   <p>Exit when the first instance of the web process is healthy</p>
        /// </summary>
        [Pure]
        public static T ResetNoWait<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Enables <see cref="CloudFoundryPushSettings.NoWait"/></em></p>
        ///   <p>Exit when the first instance of the web process is healthy</p>
        /// </summary>
        [Pure]
        public static T EnableNoWait<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Disables <see cref="CloudFoundryPushSettings.NoWait"/></em></p>
        ///   <p>Exit when the first instance of the web process is healthy</p>
        /// </summary>
        [Pure]
        public static T DisableNoWait<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Toggles <see cref="CloudFoundryPushSettings.NoWait"/></em></p>
        ///   <p>Exit when the first instance of the web process is healthy</p>
        /// </summary>
        [Pure]
        public static T ToggleNoWait<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        #region StartCommand
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryPushSettings.StartCommand"/></em></p>
        ///   <p>Startup command</p>
        /// </summary>
        [Pure]
        public static T SetStartCommand<T>(this T toolSettings, string startCommand) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.StartCommand = startCommand;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryPushSettings.StartCommand"/></em></p>
        ///   <p>Startup command</p>
        /// </summary>
        [Pure]
        public static T ResetStartCommand<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.StartCommand = null;
            return toolSettings;
        }
        #endregion
        #region Strategy
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryPushSettings.Strategy"/></em></p>
        ///   <p>Stack to use (a stack is a pre-built file system, including an operating system, that can run apps)</p>
        /// </summary>
        [Pure]
        public static T SetStrategy<T>(this T toolSettings, Strategy strategy) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryPushSettings.Strategy"/></em></p>
        ///   <p>Stack to use (a stack is a pre-built file system, including an operating system, that can run apps)</p>
        /// </summary>
        [Pure]
        public static T ResetStrategy<T>(this T toolSettings) where T : CloudFoundryPushSettings
        {
            toolSettings = toolSettings.NewInstance();
    ...
    #endregion
    #region CloudFoundryCreateAppSettingsExtensions
    /// <summary>
    ///   Used within <see cref="CloudFoundryTasks"/>.
    /// </summary>
    [PublicAPI]
    [ExcludeFromCodeCoverage]
    public static partial class CloudFoundryCreateAppSettingsExtensions
    {
        #region Name
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryCreateAppSettings.Name"/></em></p>
        /// </summary>
        [Pure]
        public static T SetName<T>(this T toolSettings, string name) where T : CloudFoundryCreateAppSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryCreateAppSettings.Name"/></em></p>
        /// </summary>
        [Pure]
        public static T ResetName<T>(this T toolSettings) where T : CloudFoundryCreateAppSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        #region AppType
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryCreateAppSettings.AppType"/></em></p>
        ///   <p>App lifecycle type to stage and run the app (Default: buildpack)</p>
        /// </summary>
        [Pure]
        public static T SetAppType<T>(this T toolSettings, AppType appType) where T : CloudFoundryCreateAppSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.AppType = appType;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryCreateAppSettings.AppType"/></em></p>
        ///   <p>App lifecycle type to stage and run the app (Default: buildpack)</p>
        /// </summary>
        [Pure]
        public static T ResetAppType<T>(this T toolSettings) where T : CloudFoundryCreateAppSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.AppType = null;
            return toolSettings;
        }
        #endregion
    }
    #endregion
    #region CloudFoundryCreateBuildpackSettingsExtensions
    /// <summary>
    ///   Used within <see cref="CloudFoundryTasks"/>.
    /// </summary>
    [PublicAPI]
    [ExcludeFromCodeCoverage]
    public static partial class CloudFoundryCreateBuildpackSettingsExtensions
    {
        #region BuildpackName
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryCreateBuildpackSettings.BuildpackName"/></em></p>
        /// </summary>
        [Pure]
        public static T SetBuildpackName<T>(this T toolSettings, string buildpackName) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.BuildpackName = buildpackName;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryCreateBuildpackSettings.BuildpackName"/></em></p>
        /// </summary>
        [Pure]
        public static T ResetBuildpackName<T>(this T toolSettings) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.BuildpackName = null;
            return toolSettings;
        }
        #endregion
        #region Path
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryCreateBuildpackSettings.Path"/></em></p>
        ///   <p>Path to directory or zip file</p>
        /// </summary>
        [Pure]
        public static T SetPath<T>(this T toolSettings, string path) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Path = path;
            return toolSettings;
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryCreateBuildpackSettings.Path"/></em></p>
        ///   <p>Path to directory or zip file</p>
        /// </summary>
        [Pure]
        public static T ResetPath<T>(this T toolSettings) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Path = null;
            return toolSettings;
        ...
        #region Position
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryCreateBuildpackSettings.Position"/></em></p>
        ///   <p>The order in which the buildpacks are checked during buildpack auto-detection</p>
        /// </summary>
        [Pure]
        public static T SetPosition<T>(this T toolSettings, int? position) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Position = position;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryCreateBuildpackSettings.Position"/></em></p>
        ///   <p>The order in which the buildpacks are checked during buildpack auto-detection</p>
        /// </summary>
        [Pure]
        public static T ResetPosition<T>(this T toolSettings) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Position = null;
            return toolSettings;
        }
        #endregion
        #region Disable
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryCreateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T SetDisable<T>(this T toolSettings, bool? disable) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryCreateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T ResetDisable<T>(this T toolSettings) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Enables <see cref="CloudFoundryCreateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T EnableDisable<T>(this T toolSettings) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Disables <see cref="CloudFoundryCreateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T DisableDisable<T>(this T toolSettings) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Toggles <see cref="CloudFoundryCreateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T ToggleDisable<T>(this T toolSettings) where T : CloudFoundryCreateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
    ...
    #endregion
    #region CloudFoundryUpdateBuildpackSettingsExtensions
    /// <summary>
    ///   Used within <see cref="CloudFoundryTasks"/>.
    /// </summary>
    [PublicAPI]
    [ExcludeFromCodeCoverage]
    public static partial class CloudFoundryUpdateBuildpackSettingsExtensions
    {
        #region BuildpackName
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.BuildpackName"/></em></p>
        /// </summary>
        [Pure]
        public static T SetBuildpackName<T>(this T toolSettings, string buildpackName) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.BuildpackName = buildpackName;
            return toolSettings;
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.BuildpackName"/></em></p>
        /// </summary>
        [Pure]
        public static T ResetBuildpackName<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.BuildpackName = null;
            return toolSettings;
        ...
        #region AssignStack
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.AssignStack"/></em></p>
        ///   <p>Assign a stack to a buildpack that does not have a stack association</p>
        /// </summary>
        [Pure]
        public static T SetAssignStack<T>(this T toolSettings, string assignStack) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.AssignStack = assignStack;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.AssignStack"/></em></p>
        ///   <p>Assign a stack to a buildpack that does not have a stack association</p>
        /// </summary>
        [Pure]
        public static T ResetAssignStack<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.AssignStack = null;
            return toolSettings;
        }
        #endregion
        #region Disable
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T SetDisable<T>(this T toolSettings, bool? disable) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Disable = disable;
            return toolSettings;
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T ResetDisable<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Disable = null;
            return toolSettings;
        ...
        /// <summary>
        ///   <p><em>Enables <see cref="CloudFoundryUpdateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T EnableDisable<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Disable = true;
            return toolSettings;
        ...
        /// <summary>
        ///   <p><em>Disables <see cref="CloudFoundryUpdateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T DisableDisable<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Disable = false;
            return toolSettings;
        ...
        /// <summary>
        ///   <p><em>Toggles <see cref="CloudFoundryUpdateBuildpackSettings.Disable"/></em></p>
        ///   <p>Disable the buildpack from being used for staging</p>
        /// </summary>
        [Pure]
        public static T ToggleDisable<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Disable = !toolSettings.Disable;
            return toolSettings;
        ...
        #region Enable
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.Enable"/></em></p>
        ///   <p>Enable the buildpack to be used for staging</p>
        /// </summary>
        [Pure]
        public static T SetEnable<T>(this T toolSettings, bool? enable) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.Enable"/></em></p>
        ///   <p>Enable the buildpack to be used for staging</p>
        /// </summary>
        [Pure]
        public static T ResetEnable<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Enables <see cref="CloudFoundryUpdateBuildpackSettings.Enable"/></em></p>
        ///   <p>Enable the buildpack to be used for staging</p>
        /// </summary>
        [Pure]
        public static T EnableEnable<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Disables <see cref="CloudFoundryUpdateBuildpackSettings.Enable"/></em></p>
        ///   <p>Enable the buildpack to be used for staging</p>
        /// </summary>
        [Pure]
        public static T DisableEnable<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Toggles <see cref="CloudFoundryUpdateBuildpackSettings.Enable"/></em></p>
        ///   <p>Enable the buildpack to be used for staging</p>
        /// </summary>
        [Pure]
        public static T ToggleEnable<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        #region Lock
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.Lock"/></em></p>
        ///   <p>Lock the buildpack to prevent updates</p>
        /// </summary>
        [Pure]
        public static T SetLock<T>(this T toolSettings, bool? @lock) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.Lock"/></em></p>
        ///   <p>Lock the buildpack to prevent updates</p>
        /// </summary>
        [Pure]
        public static T ResetLock<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Enables <see cref="CloudFoundryUpdateBuildpackSettings.Lock"/></em></p>
        ///   <p>Lock the buildpack to prevent updates</p>
        /// </summary>
        [Pure]
        public static T EnableLock<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Disables <see cref="CloudFoundryUpdateBuildpackSettings.Lock"/></em></p>
        ///   <p>Lock the buildpack to prevent updates</p>
        /// </summary>
        [Pure]
        public static T DisableLock<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        /// <summary>
        ///   <p><em>Toggles <see cref="CloudFoundryUpdateBuildpackSettings.Lock"/></em></p>
        ///   <p>Lock the buildpack to prevent updates</p>
        /// </summary>
        [Pure]
        public static T ToggleLock<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
        ...
        #region Path
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.Path"/></em></p>
        ///   <p>Path to directory or zip file</p>
        /// </summary>
        [Pure]
        public static T SetPath<T>(this T toolSettings, string path) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Path = path;
            return toolSettings;
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.Path"/></em></p>
        ///   <p>Path to directory or zip file</p>
        /// </summary>
        [Pure]
        public static T ResetPath<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Path = null;
            return toolSettings;
        ...
        #region Position
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.Position"/></em></p>
        ///   <p>The order in which the buildpacks are checked during buildpack auto-detection</p>
        /// </summary>
        [Pure]
        public static T SetPosition<T>(this T toolSettings, int? position) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Position = position;
            return toolSettings;
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.Position"/></em></p>
        ///   <p>The order in which the buildpacks are checked during buildpack auto-detection</p>
        /// </summary>
        [Pure]
        public static T ResetPosition<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Position = null;
            return toolSettings;
        ...
        #region Rename
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.Rename"/></em></p>
        ///   <p>Rename an existing buildpack</p>
        /// </summary>
        [Pure]
        public static T SetRename<T>(this T toolSettings, string rename) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Rename = rename;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.Rename"/></em></p>
        ///   <p>Rename an existing buildpack</p>
        /// </summary>
        [Pure]
        public static T ResetRename<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Rename = null;
            return toolSettings;
        }
        #endregion
        #region Stack
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.Stack"/></em></p>
        ///   <p>Specify stack to disambiguate buildpacks with the same name</p>
        /// </summary>
        [Pure]
        public static T SetStack<T>(this T toolSettings, string stack) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Stack = stack;
            return toolSettings;
        ...
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.Stack"/></em></p>
        ///   <p>Specify stack to disambiguate buildpacks with the same name</p>
        /// </summary>
        [Pure]
        public static T ResetStack<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Stack = null;
            return toolSettings;
        ...
        #region Unlock
        /// <summary>
        ///   <p><em>Sets <see cref="CloudFoundryUpdateBuildpackSettings.Unlock"/></em></p>
        ///   <p>Unlock the buildpack to enable updates</p>
        /// </summary>
        [Pure]
        public static T SetUnlock<T>(this T toolSettings, bool? unlock) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Unlock = unlock;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Resets <see cref="CloudFoundryUpdateBuildpackSettings.Unlock"/></em></p>
        ///   <p>Unlock the buildpack to enable updates</p>
        /// </summary>
        [Pure]
        public static T ResetUnlock<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Unlock = null;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Enables <see cref="CloudFoundryUpdateBuildpackSettings.Unlock"/></em></p>
        ///   <p>Unlock the buildpack to enable updates</p>
        /// </summary>
        [Pure]
        public static T EnableUnlock<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Unlock = true;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Disables <see cref="CloudFoundryUpdateBuildpackSettings.Unlock"/></em></p>
        ///   <p>Unlock the buildpack to enable updates</p>
        /// </summary>
        [Pure]
        public static T DisableUnlock<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Unlock = false;
            return toolSettings;
        }
        /// <summary>
        ///   <p><em>Toggles <see cref="CloudFoundryUpdateBuildpackSettings.Unlock"/></em></p>
        ///   <p>Unlock the buildpack to enable updates</p>
        /// </summary>
        [Pure]
        public static T ToggleUnlock<T>(this T toolSettings) where T : CloudFoundryUpdateBuildpackSettings
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Unlock = !toolSettings.Unlock;
            return toolSettings;
        }
        #endregion
    }
    ...
    [Serializable]
    [ExcludeFromCodeCoverage]
    [TypeConverter(typeof(TypeConverter<Strategy>))]
    public partial class Strategy : Enumeration
    {
        public static Strategy rolling = (Strategy) "rolling";
        public static Strategy null_ = (Strategy) "null";
        public static implicit operator Strategy(string value)
        {
            return new Strategy { Value = value };
        }
    }
    #endregion
    #region AppType
    ...
    [Serializable]
    [ExcludeFromCodeCoverage]
    [TypeConverter(typeof(TypeConverter<AppType>))]
    public partial class AppType : Enumeration
    {
        public static AppType buildpack = (AppType) "buildpack";
        public static AppType docker = (AppType) "docker";
        public static implicit operator AppType(string value)
        {
            return new AppType { Value = value };
        }
    }
    #endregion
}
